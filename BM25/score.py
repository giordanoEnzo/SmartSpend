...
class ScoreBM25():
    def __init__(self, termo_consulta, total_documentos, total_documento_termo,
                 total_termos_documento, total_tokens_documento, tf, idf):
        self.k1 = 1.5
        self.b = 0
        self.k3 = 1000
    ...
    def term_frequency(self):
        ...
        return frequencia * (self.k1 + 1) / frequencia + self.k1 * (1 - self.b + self.b * (self.total_tokens_documento / avgdl))
